                    ...
                    <Col md={6}>
                        ...
                        <form onSubmit={onSubmit}>{/* Envia los datos */}
                            <Row>
                                ...
                                <Col>
                                    <input type="tel"  placeholder="Telefono" {...register('tel', {required:true})}/>
                                </Col>

                                <Col>
                                    <textarea type="text" row="6" placeholder="Mensaje" {...register('message', {required:true})}/>
                                </Col>
